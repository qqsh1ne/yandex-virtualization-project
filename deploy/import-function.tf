...
resource yandex_function import_function {
  ...
  environment        = {
    ...
    IMAGES_BUCKET_NAME    = yandex_storage_bucket.parks_images_bucket.bucket
    DOCUMENT_API_ENDPOINT = yandex_ydb_database_serverless.parks_database.document_api_endpoint
  }
}
